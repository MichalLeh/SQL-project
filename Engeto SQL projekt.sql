...
wet.city, wet.binary_day, wet.season_code, wet.daily_avg_temp, wet.count_rain_hours, wet.max_day_wind
FROM 
...
left join
-- count_rain_hours - počet hodin v daném dni, kdy byly srážky nenulové
